...
export default function TidalBufferSlider({
  buffer,
  setBuffer,
}: TidalBufferSliderProps) {
  ...
  return (
    <div className='mb-4'>
      <label className='block text-m font-semibold text-gray-700 mb-0'>
        Buffer between tide height and restriction height: {buffer.toFixed(1)}{' '}
        ft
      </label>
        ...
        <div className='mt-0 p-3 bg-yellow-50 border border-yellow-200 rounded-md'>
          <div className='flex items-center'>
            ...
            <p className='text-sm text-yellow-800'>
              A buffer of at least 1 ft is recommended for safety.
            </p>
          </div>
        </div>
      )}
