...
export default function DistanceRangeSlider({ minDistance, setMinDistance, maxDistance, setMaxDistance }: DistanceRangeSliderProps) {
    ...
    return (
        <div className={maxDistance > 10 ? "mb-3" : "mb-10"}>
            <label className="block text-m font-semibold text-gray-700 mb-3">
                Distance per day: {minDistance.toFixed(1)} – {maxDistance.toFixed(1)} miles
            </label>
                ...
                <div className="mt-6 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                    <div className="flex items-center">
                        ...
                        <p className="text-sm text-yellow-800">
                            It's difficult to hike more than 10 miles per day due to uneven terrain.
                        </p>
                    </div>
                </div>
            )}
